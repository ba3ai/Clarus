...
def roi_monthly():
    """
    GET /api/market/roi_monthly?symbols=^GSPC,AAPL&start=2018-01-01&end=2025-12-31
    Returns per-symbol monthly ROI computed from stored monthly bars:
      roi_pct = ((close - open) / open) * 100
    """
